...
?>
<br>
<button type="button" id="addRow" style="float: right; margin-right: 215px;">Add Test Case</button>
<br><br>
<input type="submit" value="Submit" style="float: right; margin-right: 215px;">
</form>
</div>
</body>
</html>