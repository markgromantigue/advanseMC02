...
<script>
	$(document).ready(function(){
		$("#addRow").on("click",function() {
			$("#inputRow").append('<tr><td><input type="date" name="date[]" required></td><td><input type="number" name="number[]" required></td><td><select name="type[]"><option value="10">10 - Documentation</option><option value="20">20 - Syntax</option><option value="30">30 - Build/Package</option><option value="40">40 - Assignment</option><option value="50">50 - Interface</option><option value="60">60 - Checking</option><option value="70">70 - Data</option><option value="80">80 - Function</option><option value="90">90 - System</option><option value="100">100 - Environment</option></select></td><td><select name="inject[]"><option value="planning">Planning</option><option value="designing">Designing</option><option value="coding">Coding</option><option value="compiling">Compiling</option><option value="testing">Testing</option><option value="postmortem">Postmortem</option></select></td><td><select name="remove[]"><option value="planning">Planning</option><option value="designing">Designing</option><option value="coding">Coding</option><option value="compiling">Compiling</option><option value="testing">Testing</option><option value="postmortem">Postmortem</option></select></td><td><input type="number" name="fixtime[]" required></td><td><input type="number" name="fixdefect[]"></td></tr>');
		});
	});
</script>
