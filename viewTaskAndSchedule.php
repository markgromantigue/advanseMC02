            ...
            <table border="1" width="1046" id="myTable">
                <tbody>
                    ...
                    <?php
                        ...
                        if($taskActualCount > 0){
                            while (($row2 = mysql_fetch_array($rs2))) {
                                ...
                                echo "<tr>                         <td width='87'>                             <p style='text-align: center;'>" . $i . "</p>                         </td>                         <td width='87'>                             <select name='phase[]' readonly>                                 <option value='" . $row2['task_name'] . "' selected>" . $row2['task_name'] . "</option>                                 <option value='Planning' disabled>Planning</option>                                 <option value='Design' disabled>Design</option>                                 <option value='Code' disabled>Code</option>                                 <option value='Compile' disabled>Compile</option>                                 <option value='Test' disabled>Test</option>                                 <option value='Postmortem' disabled>Postmortem</option>                             </select>                         </td>                         <td width='87'>                             <input type='text' size='8' value='" . $row2['hours'] . "' name='hours[]' id='hours" . $i . "' class='toAdd' readonly>                         </td>                         <td width='87'>                             <input type='text' size='8' value='" . $row2['planned_value'] . "' name='pv[]' id='pv" . $i . "' readonly>                         </td>                         <td width='87'>                             <input type='text' size='8' name='taskch[]' value='" . $row2['cumulative_hours'] . "' id='taskch" . $i . "' readonly>                         </td>                         <td width='87'>                             <input type='text' size='9' name='taskcpv[]' id='taskcpv" . $i . "' value='" . $row2['cumulative_pv'] . "' readonly>                         </td>                         <td width='87'>                             <input type='date' step=7 min=20" . $i . "4-09-08 name='taskDateMonday[]' value='" . $row2['date_monday'] . "' id='taskDateMonday" . $i . "' readonly>                         </td>                         <td width='87'>                             <input type='date' name='taskDate[]' value='" . $row4['date'] . "' id='taskDate" . $i . "' data-validation='required'>                         </td>                         <td width='87'>                             <input type='text' size='8' name='ev[]' value='" . $row4['earned_value'] . "' id='ev" . $i . "' data-validation='number' data-validation-allowing='float'>                         </td>                         <td width='87'>                             <input type='text' size='8' name='taskcev[]' value='" . $row4['cumulative_ev'] . "' id='taskcev" . $i . "' data-validation='number' data-validation-allowing='float'>                         </td>                         <td width='87'>                             <input type='text' size='8' name='actualev[]' value='" . $row4['actual_ev'] . "' id='actualev" . $i . "' class='toAdd2' data-validation='number' data-validation-allowing='float'>                         </td>                         <td width='87'>                             <input type='text' size='8' name='caev[]' value='" . $row4['cumulative_actual_ev'] . "' id='caev" . $i . "' data-validation='number' data-validation-allowing='float'>                         </td>                     </tr>";
                                $i++;
                            }
                        }else{
                            while ($row2 = mysql_fetch_array($rs2)) {
                                echo "<tr>                         <td width='87'>                             <p style='text-align: center;'>" . $i . "</p>                         </td>                         <td width='87'>                             <select name='phase[]' readonly>                                 <option value='' disabled selected>" . $row2['task_name'] . "</option>                                 <option value='Planning' disabled>Planning</option>                                 <option value='Design' disabled>Design</option>                                 <option value='Code' disabled>Code</option>                                 <option value='Compile' disabled>Compile</option>                                 <option value='Test' disabled>Test</option>                                 <option value='Postmortem' disabled>Postmortem</option>                             </select>                         </td>                         <td width='87'>                             <input type='text' size='8' value='" . $row2['hours'] . "' name='hours[]' id='hours" . $i . "' class='toAdd' readonly>                         </td>                         <td width='87'>                             <input type='text' size='8' value='" . $row2['planned_value'] . "' name='pv[]' id='pv" . $i . "' readonly>                         </td>                         <td width='87'>                             <input type='text' size='8' name='taskch[]' value='" . $row2['cumulative_hours'] . "' id='taskch" . $i . "' readonly>                         </td>                         <td width='87'>                             <input type='text' size='9' name='taskcpv[]' id='taskcpv" . $i . "' value='" . $row2['cumulative_pv'] . "' readonly>                         </td>                         <td width='87'>                             <input type='date' step=7 min=20" . $i . "4-09-08 name='taskDateMonday[]' value='" . $row2['date_monday'] . "' id='taskDateMonday" . $i . "' readonly>                         </td>                         <td width='87'>                             <input type='date' name='taskDate[]' id='taskDate" . $i . "' data-validation='required'>                         </td>                         <td width='87'>                             <input type='text' size='8' name='ev[]' id='ev" . $i . "' data-validation='number' data-validation-allowing='float'>                         </td>                         <td width='87'>                             <input type='text' size='8' name='taskcev[]' id='taskcev" . $i . "' data-validation='number' data-validation-allowing='float'>                         </td>                         <td width='87'>                             <input type='text' size='8' name='actualev[]' id='actualev" . $i . "' class='toAdd2' data-validation='number' data-validation-allowing='float'>                         </td>                         <td width='87'>                             <input type='text' size='8' name='caev[]' id='caev" . $i . "' data-validation='number' data-validation-allowing='float'>                         </td>                     </tr>";
                                $i++;
                            }
                        }
                        ?>
                    <tr class="addMore">
                        ...
                        <td width="87">
                            <input type="text" size="8" name="totalactualev" id="totalBA2" value="<?php echo $row4['total_actual_ev']; ?>" readonly>   
                        </td>
                        <td width="87">
                            <p style="text-align: center;">1.0</p>
                        </td>
                    ...
                    <?php
                        ...
                        if($scheduleActualCount > 0){
                            while (($row3 = mysql_fetch_array($rs3))) {
                                ...
                                echo "<tr>                         <td style='width: 109px;'>                             <p style='text-align: center;'>" . $j . "</p>                         </td>                         <td style='width: 109px;'>                             <input type='date' step=7 min=2014-09-08 name='schedDateMonday[]' id='schedDateMonday" . $j . "' value='" . $row3['date_monday'] . "' readonly>                         </td>                         <td style='width: 110px;'>                             <input type='text' size='11' name='plandh[]' id='plandh" . $j . "' value='" . $row3['direct_hours'] . "' readonly>                         </td>                         <td style='width: 110px;'>                             <input type='text' size='11' name='schedch[]' id='schedch" . $j . "' value='" . $row3['cumulative_hours'] . "' readonly>                         </td>                         <td style='width: 110px;'>                             <input type='text' size='11' name='schedcpv[]' id='schedcpv" . $j . "' value='" . $row3['cumulative_pv'] . "' readonly>                         </td>                         <td style='width: 110px;'>                             <input type='text' size='11' name='actualdh[]' value='" . $row5['direct_hours'] . "' id='actualdh" . $j . "' data-validation='number' data-validation-allowing='float'>                         </td>                         <td style='width: 110px;'>                             <input type='text' size='11' name='actualschedch[]' value='" . $row5['cumulative_hours'] . "' id='actualschedch" . $j . "' data-validation='number' data-validation-allowing='float'>                         </td>                         <td style='width: 110px;'>                             <input type='text' size='11' name='schedcev[]' value='" . $row5['cumulative_ev'] . "' id='schedcev" . $j . "' data-validation='number' data-validation-allowing='float'>                         </td>                         <td style='width: 110px;'>                             <input type='text' size='11' name='adjustedev[]' value='" . $row5['adjusted_ev'] . "' id='adjustedev" . $j . "' data-validation='number' data-validation-allowing='float'>                         </td>                     </tr>";
                                $j++;
                            }
                        }else{
                            while ($row3 = mysql_fetch_array($rs3)) {
                                echo "<tr>                         <td style='width: 109px;'>                             <p style='text-align: center;'>" . $j . "</p>                         </td>                         <td style='width: 109px;'>                             <input type='date' step=7 min=2014-09-08 name='schedDateMonday[]' id='schedDateMonday" . $j . "' value='" . $row3['date_monday'] . "' readonly>                         </td>                         <td style='width: 110px;'>                             <input type='text' size='11' name='plandh[]' id='plandh" . $j . "' value='" . $row3['direct_hours'] . "' readonly>                         </td>                         <td style='width: 110px;'>                             <input type='text' size='11' name='schedch[]' id='schedch" . $j . "' value='" . $row3['cumulative_hours'] . "' readonly>                         </td>                         <td style='width: 110px;'>                             <input type='text' size='11' name='schedcpv[]' id='schedcpv" . $j . "' value='" . $row3['cumulative_pv'] . "' readonly>                         </td>                         <td style='width: 110px;'>                             <input type='text' size='11' name='actualdh[]' id='actualdh" . $j . "' data-validation='number' data-validation-allowing='float'>                         </td>                         <td style='width: 110px;'>                             <input type='text' size='11' name='actualschedch[]' id='actualschedch" . $j . "' data-validation='number' data-validation-allowing='float'>                         </td>                         <td style='width: 110px;'>                             <input type='text' size='11' name='schedcev[]' id='schedcev" . $j . "' data-validation='number' data-validation-allowing='float'>                         </td>                         <td style='width: 110px;'>                             <input type='text' size='11' name='adjustedev[]' id='adjustedev" . $j . "' data-validation='number' data-validation-allowing='float'>                         </td>                     </tr>";
                                $j++;
                            }
                        }
                    ?>
